...
def messageReceived(destination,message,headers):
    ...
    es.indices.delete(index="biac_safemaximo_monthly", ignore=[400, 404])
    ...
    for screen in screens:
        ...
        datatotal = es.search(index="biac_503maximo", body=getquery, size=10000)
        ...
        dataok = es.search(index="biac_503maximo", body=getokquery, size=10000)
        ...
        datadoneok =  es.search(index="biac_safemaximo", body=doneokquery, size=1000)
        datatotal =  es.search(index="biac_safemaximo", body=donenokquery, size=1000)
        ...
        datafuture = es.search(index="biac_safemaximo", body=getquery, size=10000)
